...
export const PADEL_ZONE_SYSTEMS: ZoneSystem[] = [
  {
    id: "traffic-light",
    name: "Traffic Light",
    description: "Simple 3-zone system (Green/Orange/Purple)",
    zones: PADEL_TRAFFIC_LIGHT_ZONES,
    coachingTips:
      "Coaches use the Traffic Light system to teach court positioning basics. Green zone (net) is where you want to be to finish points. Orange zone (transition) should be crossed quickly—don't linger here. Purple zone (defense) means you're under pressure; use lobs to reset and work your way forward.",
  },
  {
    id: "6-zone",
...
export const TENNIS_ZONE_SYSTEMS: ZoneSystem[] = [
  {
    ...
    coachingTips:
      "The Tennis Traffic Light system shows court positioning fundamentals. Green (net) is where you finish points. Orange (no-man's land) is DANGEROUS—you'll get passed if you stay here! Blue (baseline) is your rally home base. Purple (deep defense) means you're retrieving; work your way back to the baseline.",
  },
  {
    id: "6-zone",
    name: "6-Zone Tactical",
